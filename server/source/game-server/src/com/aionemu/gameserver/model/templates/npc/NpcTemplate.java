...
public class NpcTemplate extends CreatureTemplate {
	...
	/**
	 * Elemental weakness of this NPC (optional).
	 * When a skill whose SkillElement matches this value hits, weakness amplification and break mechanics apply.
	 * Configured directly in npc_templates XML: <code>weakness_element="FIRE"</code>
	 */
	@XmlAttribute(name = "weakness_element")
	private SkillElement weaknessElement;

	/** Accumulated weak-hit damage needed to trigger a break state. 0 = no break mechanic. */
	@XmlAttribute(name = "weakness_break_threshold")
	private int weaknessBreakThreshold = 0;

	public SkillElement getWeaknessElement() {
		return weaknessElement;
	}

	public int getWeaknessBreakThreshold() {
		return weaknessBreakThreshold;
	}
