...
public class NetworkConfig {
	 ...
	 * every client connection. Enables real client IP recovery when running
	 * behind the gate. Leave false for direct-connect development.
	 */
	@Property(key = "gameserver.network.client.expect_proxy_v2", defaultValue = "false")
