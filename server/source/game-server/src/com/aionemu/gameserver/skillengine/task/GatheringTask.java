...
public class GatheringTask extends AbstractCraftTask {
	...
	protected boolean onSuccessFinish() {
		...
		// When one-click gathering is enabled, award all harvest attempts' worth of items at once
		int baseCount = CustomConfig.GATHERING_ONE_CLICK ? template.getHarvestCount() : 1;
		ItemService.addItem(requester, material.getItemId(), Rates.GATHERING_COUNT.calcResult(requester, baseCount));
