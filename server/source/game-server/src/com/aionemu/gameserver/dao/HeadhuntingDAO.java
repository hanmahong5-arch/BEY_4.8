...
public class HeadhuntingDAO {
	...
	private static final String UPDATE_QUERY = "INSERT INTO headhunting (hunter_id, accumulated_kills, last_update) VALUES (?,?,?) ON CONFLICT (hunter_id) DO UPDATE SET accumulated_kills=EXCLUDED.accumulated_kills, last_update=EXCLUDED.last_update";
