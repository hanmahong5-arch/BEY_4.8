...
public class PlayerPunishmentsDAO {
	...
	public static final String REPLACE_QUERY = "INSERT INTO player_punishments VALUES (?,?,?,?,?) ON CONFLICT (player_id, punishment_type) DO UPDATE SET start_time=EXCLUDED.start_time, duration=EXCLUDED.duration, reason=EXCLUDED.reason";
