...
public class PlayerSkillListDAO {
	...
	public static final String INSERT_QUERY = "INSERT INTO player_skills (player_id, skill_id, skill_level) VALUES (?, ?, ?) ON CONFLICT (player_id, skill_id) DO UPDATE SET skill_level=EXCLUDED.skill_level";
