...
public class VeteranRewardDAO {
	...
	private static final String UPDATE_QUERY = "INSERT INTO player_veteran_rewards (player_id, received_months) VALUES (?,?) ON CONFLICT (player_id) DO UPDATE SET received_months=EXCLUDED.received_months";
