...
public class AccountPassportsDAO {
	...
	private static final String INSERT_QUERY = "INSERT INTO account_passports (account_id, passport_id, rewarded, arrive_date) VALUES (?,?,?,?) ON CONFLICT (account_id, passport_id, arrive_date) DO UPDATE SET rewarded = GREATEST(EXCLUDED.rewarded, account_passports.rewarded)";
